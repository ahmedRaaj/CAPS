...
values
-- Raj
(9, 1, STR_TO_DATE('31-10-2016', '%d-%m-%Y'), STR_TO_DATE('4-11-2016', '%d-%m-%Y'), '4', 'PENDING'),
(9, 2, STR_TO_DATE('24-11-2016', '%d-%m-%Y'), STR_TO_DATE('12-12-2016', '%d-%m-%Y'), '3', 'PENDING'),
(9, 3, STR_TO_DATE('23-10-2016', '%d-%m-%Y'), STR_TO_DATE('14-12-2016', '%d-%m-%Y'), '4', 'REJECTED'),
(9, 4, STR_TO_DATE('24-10-2016', '%d-%m-%Y'), STR_TO_DATE('28-10-2016', '%d-%m-%Y'), '3', 'APPROVED'),
(9, 5, STR_TO_DATE('8-8-2016', '%d-%m-%Y'), STR_TO_DATE('26-8-2016', '%d-%m-%Y'), '4', 'COMPLETED'),
(9, 6, STR_TO_DATE('5-9-2016', '%d-%m-%Y'), STR_TO_DATE('23-9-2016', '%d-%m-%Y'), '3', 'PENDING'),
(9, 7, STR_TO_DATE('29-8-2016', '%d-%m-%Y'), STR_TO_DATE('2-9-2016', '%d-%m-%Y'), '4', 'COMPLETED'),
(9, 8, STR_TO_DATE('26-9-2016', '%d-%m-%Y'), STR_TO_DATE('30-9-2016', '%d-%m-%Y'), '3', 'APPROVED'),
-- Janaki
(2, 1, STR_TO_DATE('31-10-2016', '%d-%m-%Y'), STR_TO_DATE('4-11-2016', '%d-%m-%Y'), '3', 'APPROVED'),
(2, 2, STR_TO_DATE('24-11-2016', '%d-%m-%Y'), STR_TO_DATE('12-12-2016', '%d-%m-%Y'), '4', 'COMPLETED'),
(2, 3, STR_TO_DATE('14-12-2016', '%d-%m-%Y'), STR_TO_DATE('23-10-2016', '%d-%m-%Y'), '3', 'COMPLETED'),
(2, 4, STR_TO_DATE('24-10-2016', '%d-%m-%Y'), STR_TO_DATE('28-10-2016', '%d-%m-%Y'), '4', 'APPROVED'),
(2, 5, STR_TO_DATE('8-8-2016', '%d-%m-%Y'), STR_TO_DATE('26-8-2016', '%d-%m-%Y'), '3', 'REJECTED'),
(2, 6, STR_TO_DATE('5-9-2016', '%d-%m-%Y'), STR_TO_DATE('23-9-2016', '%d-%m-%Y'), '4', 'REJECTED'),
(2, 7, STR_TO_DATE('29-8-2016', '%d-%m-%Y'), STR_TO_DATE('2-9-2016', '%d-%m-%Y'), '3', 'APPROVED'),
(2, 8, STR_TO_DATE('26-9-2016', '%d-%m-%Y'), STR_TO_DATE('30-9-2016', '%d-%m-%Y'), '4', 'APPROVED'),
--  Zoe
(3, 1, STR_TO_DATE('31-10-2016', '%d-%m-%Y'), STR_TO_DATE('4-11-2016', '%d-%m-%Y'), '4', 'APPROVED'),
(3, 2, STR_TO_DATE('24-11-2016', '%d-%m-%Y'), STR_TO_DATE('12-12-2016', '%d-%m-%Y'), '3', 'REJECTED'),
(3, 3, STR_TO_DATE('14-12-2016', '%d-%m-%Y'), STR_TO_DATE('23-10-2016', '%d-%m-%Y'), '4', 'PENDING'),
(3, 4, STR_TO_DATE('24-10-2016', '%d-%m-%Y'), STR_TO_DATE('28-10-2016', '%d-%m-%Y'), '3', 'COMPLETED'),
(3, 5, STR_TO_DATE('8-8-2016', '%d-%m-%Y'), STR_TO_DATE('26-8-2016', '%d-%m-%Y'), '4', 'APPROVED'),
...
(3, 8, STR_TO_DATE('26-9-2016', '%d-%m-%Y'), STR_TO_DATE('30-9-2016', '%d-%m-%Y'), '3', 'PENDING'),
-- Kaung
(4, 1, STR_TO_DATE('31-10-2016', '%d-%m-%Y'), STR_TO_DATE('4-11-2016', '%d-%m-%Y'), '4', 'COMPLETED'),
(4, 2, STR_TO_DATE('24-11-2016', '%d-%m-%Y'), STR_TO_DATE('12-12-2016', '%d-%m-%Y'), '4', 'PENDING'),
(4, 3, STR_TO_DATE('14-12-2016', '%d-%m-%Y'), STR_TO_DATE('23-10-2016', '%d-%m-%Y'), '4', 'PENDING'),
...
(4, 6, STR_TO_DATE('5-9-2016', '%d-%m-%Y'), STR_TO_DATE('23-9-2016', '%d-%m-%Y'), '4', 'APPROVED'),
(4, 7, STR_TO_DATE('29-8-2016', '%d-%m-%Y'), STR_TO_DATE('2-9-2016', '%d-%m-%Y'), '4', 'APPROVED'),
...
(5, 2, STR_TO_DATE('24-11-2016', '%d-%m-%Y'), STR_TO_DATE('12-12-2016', '%d-%m-%Y'), '4', 'PENDING'),
(5, 3, STR_TO_DATE('14-12-2016', '%d-%m-%Y'), STR_TO_DATE('23-10-2016', '%d-%m-%Y'), '4', 'PENDING'),
(5, 4, STR_TO_DATE('24-10-2016', '%d-%m-%Y'), STR_TO_DATE('28-10-2016', '%d-%m-%Y'), '4', 'COMPLETED'),
(5, 5, STR_TO_DATE('8-8-2016', '%d-%m-%Y'), STR_TO_DATE('26-8-2016', '%d-%m-%Y'), '3', 'APPROVED'),
(5, 6, STR_TO_DATE('5-9-2016', '%d-%m-%Y'), STR_TO_DATE('23-9-2016', '%d-%m-%Y'), '3', 'COMPLETED'),
(5, 7, STR_TO_DATE('29-8-2016', '%d-%m-%Y'), STR_TO_DATE('2-9-2016', '%d-%m-%Y'), '3', 'PENDING'),
(5, 8, STR_TO_DATE('26-9-2016', '%d-%m-%Y'), STR_TO_DATE('30-9-2016', '%d-%m-%Y'), '3', 'APPROVED'),
-- Zwe
(6, 1, STR_TO_DATE('31-10-2016', '%d-%m-%Y'), STR_TO_DATE('4-11-2016', '%d-%m-%Y'), '3', 'APPROVED'),
(6, 2, STR_TO_DATE('24-11-2016', '%d-%m-%Y'), STR_TO_DATE('12-12-2016', '%d-%m-%Y'), '3', 'APPROVED'),
(6, 3, STR_TO_DATE('14-12-2016', '%d-%m-%Y'), STR_TO_DATE('23-10-2016', '%d-%m-%Y'), '3', 'PENDING'),
(6, 4, STR_TO_DATE('24-10-2016', '%d-%m-%Y'), STR_TO_DATE('28-10-2016', '%d-%m-%Y'), '3', 'PENDING'),
(6, 5, STR_TO_DATE('8-8-2016', '%d-%m-%Y'), STR_TO_DATE('26-8-2016', '%d-%m-%Y'), '4', 'COMPLETED'),
(6, 6, STR_TO_DATE('5-9-2016', '%d-%m-%Y'), STR_TO_DATE('23-9-2016', '%d-%m-%Y'), '4', 'APPROVED'),
(6, 7, STR_TO_DATE('29-8-2016', '%d-%m-%Y'), STR_TO_DATE('2-9-2016', '%d-%m-%Y'), '4', 'REJECTED'),
...
(7, 2, STR_TO_DATE('24-11-2016', '%d-%m-%Y'), STR_TO_DATE('12-12-2016', '%d-%m-%Y'), '4', 'COMPLETED'),
(7, 3, STR_TO_DATE('14-12-2016', '%d-%m-%Y'), STR_TO_DATE('23-10-2016', '%d-%m-%Y'), '4', 'APPROVED'),
(7, 4, STR_TO_DATE('24-10-2016', '%d-%m-%Y'), STR_TO_DATE('28-10-2016', '%d-%m-%Y'), '4', 'PENDING'),
(7, 5, STR_TO_DATE('8-8-2016', '%d-%m-%Y'), STR_TO_DATE('26-8-2016', '%d-%m-%Y'), '4', 'REJECTED'),
(7, 6, STR_TO_DATE('5-9-2016', '%d-%m-%Y'), STR_TO_DATE('23-9-2016', '%d-%m-%Y'), '4', 'PENDING'),
(7, 7, STR_TO_DATE('29-8-2016', '%d-%m-%Y'), STR_TO_DATE('2-9-2016', '%d-%m-%Y'), '3', 'REJECTED'),
(7, 8, STR_TO_DATE('26-9-2016', '%d-%m-%Y'), STR_TO_DATE('30-9-2016', '%d-%m-%Y'), '3', 'PENDING'),
-- Lau
