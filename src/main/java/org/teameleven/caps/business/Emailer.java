...
public class Emailer {
     private static String username = "ahmedraaj@gmail.com";
    private static String password = "al-aminSa7%google";
    private static String fromEmailAddress = "ahmedraaj@gmail.com";
    private static String sendToEmailAddress = new String();
    private static  String emailSubject = new String();
   private static String messageFormat=" text/html;  charset=UTF-8";
   private static String localUrl="http://localhost:8080/Caps/";
...
//        props.put("mail.smtp.port", "587");
        ...
        try {
            ...
            message.setContent(MailContent(student),messageFormat);
   ...
   private static String MailContent(Student student){
